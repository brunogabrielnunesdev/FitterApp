...
export function ForgotPasswordScreen() {
  ...
  return (
    <AuthScreen eyebrow="RECUPERAR ACESSO" title="Redefina sua senha." subtitle="Informe seu e-mail. Quando a entrega de e-mail estiver ativa, você receberá o link de redefinição." footer={<Pressable onPress={() => router.back()}><Text style={authScreenStyles.footer}>VOLTAR PARA O LOGIN</Text></Pressable>}>
