...
public class AcademyProfile {
    ...
    public AcademyProfileStatus getStatus() {
        return status;
    }

    public AcademyProfileRevision getCurrentRevision() {
        return currentRevision;
    }

    public AcademyProfileRevision getPublishedRevision() {
