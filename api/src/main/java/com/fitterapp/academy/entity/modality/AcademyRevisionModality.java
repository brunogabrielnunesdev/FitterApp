...
public class AcademyRevisionModality {
  ...
  @EmbeddedId private AcademyRevisionModalityId id;
  ...
  public static AcademyRevisionModality link(AcademyProfileRevision revision, Modality modality) {
    AcademyRevisionModality link = new AcademyRevisionModality();
    link.id = new AcademyRevisionModalityId(revision.getId(), modality.getId());
