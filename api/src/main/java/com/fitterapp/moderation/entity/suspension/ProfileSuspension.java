...
public class ProfileSuspension {
  ...
  public static ProfileSuspension suspendPersonal(
    ...
    ProfileSuspension suspension =
        active(report, suspendedBy, reason, previousStatus, suspendedAt, eligibleForReactivationAt);
  ...
  public void lift(User liftedBy, String liftReason, OffsetDateTime liftedAt) {
