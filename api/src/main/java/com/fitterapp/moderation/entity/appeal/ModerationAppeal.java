...
public class ModerationAppeal {
  ...
  public static ModerationAppeal forSuspension(
      ProfileSuspension suspension, User appellant, String reason, OffsetDateTime createdAt) {
  ...
  public static ModerationAppeal forAccountBlock(
      AccountBlock accountBlock, User appellant, String reason, OffsetDateTime createdAt) {
    ModerationAppeal appeal = pending(appellant, reason, createdAt);
    appeal.accountBlock = accountBlock;
    return appeal;
  }

  private static ModerationAppeal pending(User appellant, String reason, OffsetDateTime createdAt) {
  ...
  public void approve(User reviewedBy, String reviewNote, OffsetDateTime reviewedAt) {
    review(AppealStatus.APPROVED, reviewedBy, reviewNote, reviewedAt);
  }

  public void reject(User reviewedBy, String reviewNote, OffsetDateTime reviewedAt) {
    review(AppealStatus.REJECTED, reviewedBy, reviewNote, reviewedAt);
  }

  private void review(
      AppealStatus status, User reviewedBy, String reviewNote, OffsetDateTime reviewedAt) {
    this.status = status;
