...
public class Report {
  ...
  private static Report open(
      User reporter, ReportReason reason, String description, OffsetDateTime createdAt) {
  ...
  public void dismiss(String resolutionNote, User reviewedBy, OffsetDateTime reviewedAt) {
