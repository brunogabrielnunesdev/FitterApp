...
public class Profile {
  ...
  public static Profile draft(String fullName, String slug, OffsetDateTime createdAt) {
  ...
  public void setCurrentRevision(ProfileRevision revision, OffsetDateTime updatedAt) {
  ...
  public void publish(ProfileRevision revision, OffsetDateTime publishedAt) {
    currentRevision = revision;
