...
class PersonalCatalogPersistenceTests {
  ...
  void loadsModalityServiceModeAndAreaRelationships() {
    ...
    PersonalModality personalModality =
        entityManager.find(PersonalModality.class, new PersonalModalityId(personalId, (short) 1));
    PersonalServiceMode serviceMode =
        entityManager.find(
