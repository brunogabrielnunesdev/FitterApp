...
class JwtAccessTokenIssuerTests {
  ...
  void issuesSignedTokenWithIdentityRolesAndExpiration() {
    ...
    OffsetDateTime issuedAt =
        OffsetDateTime.ofInstant(Instant.now().truncatedTo(ChronoUnit.SECONDS), ZoneOffset.UTC);

    IssuedAccessToken issued =
        issuer.issue(
            userId, "bruno@fitterapp.com", Set.of(RoleName.PERSONAL, RoleName.STUDENT), issuedAt);
    ...
    assertThat(jwt.getClaimAsStringList("roles")).isEqualTo(List.of("PERSONAL", "STUDENT"));
